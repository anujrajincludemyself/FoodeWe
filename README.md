# 🍔 Foodewe — Full-Stack Food Ordering Platform

Foodewe is a modern **full-stack food delivery web application** built using the **MERN stack**.  
...
4. Protected routes use **JWT for authorization**
